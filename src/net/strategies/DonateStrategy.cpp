...
#   ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHostTls, 6666, m_userId, nullptr, nullptr, 0, true, true, mode);
#   endif
    m_pools.emplace_back(kDonateHost, 7777, m_userId, nullptr, nullptr, 0, true, false, mode);
